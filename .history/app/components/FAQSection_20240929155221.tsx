  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: "A Lemma is a term in mathematics for an intermediate result or tool to prove a theorem. We are creating LemmaOne to prove that semi-pro sports is possible in South East Asia and that SEA has one of the most vibrant sports ."
    },
    {
