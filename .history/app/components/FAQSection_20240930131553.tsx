...
const FAQSection: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: "Initially in Malaysia but we hope to expand our operations to the rest of South East Asia. Please get in touch if you'd like use to come to your region"
    },
    {
