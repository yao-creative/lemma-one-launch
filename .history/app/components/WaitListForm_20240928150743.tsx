  ...
  return (
    <div className="mt-8 w-full max-w-md">
      <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-md p-6 rounded-lg">
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium mb-2">Select Regional Levels</label>
          <div className="flex flex-wrap gap-2 mb-2">
          ...
          <p className="text-sm mt-2">Selected Regional Levels: {regionalLevels.join(', ')}</p>
        </div>

        <div className="mb-4">
          <label className="block text-sm font-medium mb-2">Select Other Levels (Must include one of Amateur, Semi-Professional, or Professional)</label>
          <div className="flex flex-wrap gap-2 mb-2">
