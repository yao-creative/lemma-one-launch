    ...
    <div className="mt-8 w-full max-w-md">
      <form className="bg-white/10 backdrop-blur-md p-6 rounded-lg">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            {(showPlayerForm ? [
              'tournament search', 'team matching', 'in-tournament features and updates','social media', 'pre-tournament previews', 'tournament merch', 'ticketing',
              , 'rankings', 'tournament earnings', 'player profiles', 'fan space'
            ] : [
