            ...
            {signUpSuccess ? (
              ...
              <div className="flex flex-col space-y-2 mt-4">
                <button
                  ...
                  className="bg-white/90 text-black p-2 rounded-lg flex items-center"
                >
                  <img src="/icons/google.svg" alt="Google" className="w-5 h-5 mr-2" /> Continue with Google
                </button>
                {isFacebookComingSoon ? (
                  ...
                  >
                    <img src="/icons/facebook.svg" alt="Facebook" className="w-5 h-5 mr-2" /> Continue with Facebook
                  </button>
                )}
                <button
                  type="button"
                ...
                >
                  <img src="/icons/google.svg" alt="Mobile" className="w-5 h-5 mr-2" /> Continue with Mobile
                </button>
              </div>
            )}
