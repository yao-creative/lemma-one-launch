          ...
          <>
            ...
            {signUpSuccess ? (
              ...
              <div className="flex flex-col space-y-2 mt-4">
                ...
                >
                  <img src="/icons/google.svg" alt="Google" className="w-6 h-6 mr-2" /> Continue with Google
                </button>
                ...
                >
                  <img src="/icons/mobile.svg" alt="Mobile" className="w-5 h-5 mr-2" /> Continue with Mobile
                </button>
              </div>
            )}
