...
import { signUpWithGoogle, signUpWithFacebook, signUpWithEmail } from '../lib/auth';
    ...
    try {
      ...
      switch (method) {
        ...
        case 'email':
          ...
          user = await signUpWithEmail(email, password, formData);
          break;
      }
            ...
            {signUpSuccess ? (
              ...
              <div className="flex flex-col space-y-2 mt-4">
                ...
                <button
                  ...
                  className="bg-green-500 text-black p-2 rounded-lg flex items-center justify-center"
                >
                  <img src="/icons/email.svg" alt="Email" className="w-6 h-6 mr-2" /> Sign up with Email
                </button>
