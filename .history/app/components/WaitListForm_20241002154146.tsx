                ...
                <div className="relative">
                  ...
                  {emailInputVisible && (
                    <input
                      ...
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="Email"
                      className="w-full p-2 rounded-full bg-black/50 text-white absolute top-0"
                    />
                  )}
                  {emailInputVisible && (
                    <button
                      ...
                      className="bg-blue-500 text-white p-2 rounded-lg flex items-center justify-center absolute top-10"
                    >
                      Submit
                    </button>
                  )}
