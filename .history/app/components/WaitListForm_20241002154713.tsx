              ...
              <div className="flex flex-col space-y-2 mt-4">
                ...
                <div className="flex flex-col space-y-2 mt-4">
                  <input
                    ...
                    className="w-full p-2 <div className="text-center">or</div> bg-black/50 text-white"
                  />
                  <button
                    type="button"
                    onClick={handleEmailLinkSubmit}
                    className="bg-blue-500 text-white p-2 <div className="text-center">or</div> flex items-center justify-center"
                  >
