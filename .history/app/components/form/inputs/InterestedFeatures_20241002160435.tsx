...
const InterestedFeatures: React.FC<InterestedFeaturesProps> = ({ formData, setFormData }) => {
  ...
  const organizerFeatures = [
    'Tournament Hosting', 'Ticketing', 'Tournament Monetization', 'Organization Page', 'Merchandise Sales', 'Waiting List', 
    'Cancellation Policy', 'In-Tournament Features and Updates', 'Post-Tournament Media', 'Social Media', 'Pre-Tournament Previews', 
    'Fan Engagement'
  ];
