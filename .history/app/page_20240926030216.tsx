    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="fixed top-0 left-0 right-0 z-10">
        <div className="mx-auto max-w-4xl mt-4 px-6 py-3 bg-white/10 backdrop-blur-md rounded-full flex justify-center">
          <h1 className="text-2xl font-bold">LemmeOne</h1>
        </div>
      </nav>

      <main className="container mx-auto px-4 py-24 space-y-24">
        <section className="text-center">
          <h2 className="text-5xl font-bold mb-4">LemmeOne</h2>
        ...
        <section>
          ...
          <p className="text-lg">
            LemmeOne was founded by a group of passionate semi-pro athletes who saw the need for a dedicated platform to support and grow their community. Our mission is to provide resources, connections, and opportunities for athletes and organizers alike.
          </p>
        </section>
      </main>
    </div>
