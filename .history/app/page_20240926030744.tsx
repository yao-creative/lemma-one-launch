    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="fixed top-0 left-0 right-0 z-10">
        <div className="mx-auto max-w-6xl mt-4 px-6 py-3 bg-white/10 backdrop-blur-md rounded-full flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-4 items-center">
            ...
            <Image src="/logo192.png" alt="LemmaOne Logo" width={32} height={32} className="ml-4" />
          </div>
      ...
      <main className="container mx-auto px-4 py-24 space-y-24">
        <section className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">LemmaOne</h2>
          <p className="text-lg md:text-xl">A space for semi-pro athletes. Growing the sport we love.</p>
        </section>

        <section ref={platformRef}>
          <h3 className="text-2xl md:text-3xl font-semibold mb-4">A Platform for Semi-Pro Athletes and Tournament Organizers</h3>
        ...
        <section ref={communityRef}>
          <h3 className="text-2xl md:text-3xl font-semibold mb-4">The Community</h3>
        ...
        <section ref={supportRef}>
          <h3 className="text-2xl md:text-3xl font-semibold mb-4">Support Us</h3>
          <p className="text-base md:text-lg mb-6">
