      ...
      <main className="container mx-auto px-4 py-24 space-y-24">
        ...
        <section ref={waitingListRef} className="text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
            <button className="px-6 py-3 rounded-full font-semibold text-white bg-gradient-to-r from-red-600 to-green-500 hover:from-red-700 hover:to-green-600 transition-all duration-300 animate-pulse">
              Players
            </button>
            <button className="px-6 py-3 rounded-full font-semibold text-white bg-gradient-to-r from-purple-600 to-yellow-400 hover:from-purple-700 hover:to-yellow-500 transition-all duration-300 animate-pulse">
              Organizers
            </button>
          </div>
        </section>
