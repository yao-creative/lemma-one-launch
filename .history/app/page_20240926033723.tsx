...
export default function Home() {
  ...
  const faqs = [
    {
      question: "What is LemmaOne?",
      answer: "LemmaOne is a platform designed for semi-pro athletes and tournament organizers to connect, grow, and showcase talent in the semi-professional sports world."
    },
    {
