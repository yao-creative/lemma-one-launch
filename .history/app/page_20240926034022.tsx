  ...
  const faqs = [
    {
      ...
      answer: "A Lemma is a term in mathematics for an intermediate result or tool to prove a theorem. We believe that LemmaOne will be a tool to prove that semi-pro sports is possible in S."
    },
    {
