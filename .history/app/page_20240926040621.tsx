      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <section ref={aboutRef} className="text-center flex flex-col items-center">
          <div className="flex items-start">
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold font-nike mb-4">About Us</h2>
              ...
              <h3 className="text-xl font-semibold mb-2">Founder: Yao</h3>
              <p className="text-sm opacity-70">
                Hi my name is Yao. I playe
              </p>
            </div>
          </div>
        </section>
