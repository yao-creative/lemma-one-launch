    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24 space-y-24">
        ...
        <section ref={aboutRef} className="text-center flex flex-col items-center">
          ...
          <p className="text-base md:text-lg max-w-2xl">
          In South East Asia, relative to the size of the populatio, especially that of the youth, and the fanbase for sports, there is a huge gap in both federation funding and professional funding for sports. LemmaOne is put together by a team of passionate athletes who want to s
          </p>
          <div className="mt-6">
