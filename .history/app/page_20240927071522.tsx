...
// In the JSX, change openFAQs to openFAQ and check like this:
{openFAQ === index && (
  ...
  const faqs = [
    ...
    {
      question: "Something to Contribute?",
      answer: (
        <div>
          I'm looking for collaborators and passionate web developers and business developers. 
          <a href="mailto:yytanwork@gmail.com" className="inline-flex items-center">
            <img src="/path/to/email-icon.png" alt="Email Icon" className="w-4 h-4 mr-1" />
            yytanwork@gmail.com
          </a>
        </div>
      )
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="mb-4">
                ...
                >
                  ...
                  <span className="text-xl sm:text-2xl">{openFAQs.includes(index) ? '−' : '+'}</span>
                </button>
