...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We're always looking for passionate web developers, designers, people with ideas, and passionate athletes to grow the community. You can contact us t at yytanwork@gmail.com"
    }
  ];
