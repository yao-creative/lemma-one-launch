...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can join the waiting list by clicking on either the 'Players' or 'Organizers' button in the 'Join the Waiting List' section and f. We'll create an account for you upon soft launch."
    },
    {
