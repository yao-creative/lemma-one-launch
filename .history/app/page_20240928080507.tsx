  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-24 space-y-16 md:space-y-24 pt-24 md:pt-32">
        ...
        <section ref={supportRef} className="text-center flex flex-col items-center pt-16 md:pt-24">
        ...
        <section ref={aboutRef} className="text-center flex flex-col items-center w-full max-w-4xl px-4 md:px-0 pt-16 md:pt-24">
