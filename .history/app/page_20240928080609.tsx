...
export default function Home() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setFormData({ name: '', sport: '', interestLevel: '', features: '' });
  ...
  return (
    <div className="min-h-screen bg-darkBlue text-white relative overflow-hidden">
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-24 space-y-16 md:space-y-24 pt-24 md:pt-32">
        ...
        <section ref={platformRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl bg-white/10 backdrop-blur-md rounded-3xl p-8">
        ...
        <section ref={waitingListRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl bg-white/10 backdrop-blur-md rounded-3xl p-8">
          ...
          <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
            <button 
              ...
              className="px-12 py-6 rounded-full text-xl font-semibold text-white bg-gradient-to-r from-orange-500 to-yellow-400 hover:from-orange-600 hover:to-yellow-500 transition-all duration-300 animate-pulse-subtle glow-button"
            >
              Players
            </button>
            <button 
              onClick={() => setShowOrganizerForm(true)}
              className="px-12 py-6 rounded-full text-xl font-semibold text-white bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 transition-all duration-300 animate-pulse-subtle glow-button"
            >
              Organizers
            </button>
          </div>
            ...
            <div className="mt-8 w-full max-w-md">
              <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-md p-6 rounded-lg">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Any features you'd like to see? (Optional)"
                  className="w-full p-2 mb-4 bg-black/50 text-white rounded"
                />
        ...
        <section ref={communityRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl bg-white/10 backdrop-blur-md rounded-3xl p-8">
        ...
        <section ref={supportRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl bg-white/10 backdrop-blur-md rounded-3xl p-8">
        ...
        <section ref={aboutRef} className="text-center flex flex-col items-center w-full max-w-4xl px-4 md:px-0 pt-16 md:pt-24 bg-white/10 backdrop-blur-md rounded-3xl p-8">
        ...
        <section ref={faqRef} className="text-center flex flex-col items-center w-full px-4 md:px-0 pt-16 md:pt-24 max-w-4xl bg-white/10 backdrop-blur-md rounded-3xl p-8">
