  ...
  return (
    <div className="min-h-screen bg-darkBlue text-white relative overflow-hidden">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-between p-4 md:p-24 space-y-16 md:space-y-24 pt-24 md:pt-32">
        ...
        <section ref={platformRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl section-glass rounded-3xl p-8">
        ...
        <section ref={waitingListRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl section-glass rounded-3xl p-8">
