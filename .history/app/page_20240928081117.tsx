  ...
  return (
    <div className="min-h-screen bg-darkBlue text-white relative overflow-hidden">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-between p-4 md:p-24 space-y-16 md:space-y-24 pt-24 md:pt-32">
        ...
        <section ref={supportRef} className="text-center flex flex-col items-center pt-16 md:pt-24 w-full max-w-4xl section-glass rounded-3xl p-8">
        ...
        <section ref={aboutRef} className="text-center flex flex-col items-center w-full max-w-4xl px-4 md:px-0 pt-16 md:pt-24 section-glass rounded-3xl p-8">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
              <div className="relative w-28 h- flex-shrink-0">
                <Image
        ...
        <section ref={faqRef} className="text-center flex flex-col items-center w-full px-4 md:px-0 pt-16 md:pt-24 max-w-4xl section-glass rounded-3xl p-8">
