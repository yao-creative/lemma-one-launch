          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
              ...
              <p className="text-sm opacity-70 text-center md:text-left md:pr-4 max-w-prose">
                Hi my name is Yao. I've been playing volleyball competitively since I was 14. I've competed in the largest national tournament when I was 17, which is a competition for the U21 age bracket nationally. After that, there was no of going pro for volleyball in Malaysia. I took a gamble and went abroad for a gap year in search of a dream. I ended up majoring in mathematics and computer science in university and five years later I'm back in this corner of the world to build things.
              </p>
            </div>
          </div>
        </section>
