        ...
        <section ref={aboutRef} className="text-center flex flex-col items-center justify-center w-full max-w-4xl section-glass rounded-3xl p-8 my-16">
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col items-center mt-4">
              <a href="https://www.linkedin.com/in/yao" className="flex items-center">
                <Image src="/icons/linkedin.svg" alt="LinkedIn" width={24} height={24} className="hover:opacity-80" />
              </a>
              <a href="mailto:yytanwork@gmail.com" className="flex items-center mt-2">
              ...
              <a href="mailto:yytanwork@gmail.com" className="flex items-center text-blue-600 hover:underline mt-2">
