    ...
    },
    {
      ...
      answer: (
        <div className="flex flex-col items-center">
          <p>We're always looking for passionate web developers, designers, people with ideas, and passionate athletes to grow the community. You can contact us through our email:</p>
        ...
        <span className="flex items-center">
          ...
          <a href="mailto:yytanwork@gmail.com" className="flex items-center ml-2">
            <Image src="/icons/email.svg" alt="Email" width={24} height={24} className="ml-2" />
          </a>
        </span>
      ),
    }
