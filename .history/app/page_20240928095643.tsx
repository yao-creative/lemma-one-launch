    ...
    },
    {
      ...
      answer: (
        <div className="flex flex-col items-center">
          <p>We're always looking for passionate web developers, designers, people with ideas, and passionate athletes to grow the community. You can contact us through our email or team memeber linkedin pages</p>
