            ...
            <div>
              ...
              <div className="flex flex-row justify-between">
                <div>
                  ...
                  <ul className="text-base md:text-lg max-w-2xl mb-4">
                    <li>Immerse yourself in the Tournament experience.</li>
              <ul className="text-base md:text-lg max-w-2xl mb-4">
                <li>Amateurs: Immerse yourself in the Tournament experience. Join Tournaments. Join Teams. Engage in the Sports Community.</li>
                <li>Competitive Athletes: Up your game to a new level. Join Tournaments. Join Teams. Get Discovered. Earn from Tournaments.</li>
              </ul>
            </div>
            <div>
              <h4 className="text-xl md:text-2xl font-semibold font-open-sans mb-4">For Organizers</h4>
              <ul className="text-base md:text-lg max-w-2xl mb-4">
                <li>Organizers: Reach a new audience. Earn from your tournaments. Scale your tournaments. Find new ways of monetization. Grow your community. Grow the sport you love.</li>
              </ul>
            </div>
          </div>
        </section>
