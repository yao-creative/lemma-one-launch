            ...
            <div>
              ...
              <div className="flex flex-row justify-between">
                <div>
                  ...
                  <ul className="text-base md:text-lg max-w-2xl mb-4 list-disc list-inside">
                ...
                <div>
                  ...
                  <ul className="text-base md:text-lg max-w-2xl mb-4 list-disc list-inside align:left">
