      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-between p-4 md:p-24 space-y-16 md:space-y-24 pt-24 md:pt-32">
        ...
        <section ref={communityRef} className="text-center flex flex-col items-center justify-center w-full max-w-4xl section-glass rounded-3xl p-8 my-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://discord.gg/q8RxTuKQXV" className="inline-flex items-center px-8 py-4 rounded-full text-lg bg-discord-purple text-white font-semibold hover:bg-discord-purple-dark transition-colors duration-300">
            <a href="https://discord.gg/q8RxTuKQXV" className="inline-flex items-center px-8 py-4 rounded-full text-lg bg-discord-purple text-white font-semibold hover:bg-discord-purple-dark transition-colors duration-300 neon-button-discord">
              Join Discord Channel <Image src="/icons/discord.svg" alt="Discord" width={40} height={40} className="ml-2" />
            </a>
            <a href="https://chat.whatsapp.com/FTkystI1sUFImgSzjzgezv" className="inline-flex items-center px-8 py-4 rounded-full text-lg bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors duration-300 neon-button-green">
              Join WhatsApp Channel <Image src="/icons/whatsapp.svg" alt="WhatsApp" width={40} height={40} className="ml-2" />
            </a>
            <a href="https://t.me/+zumEyTka9SQwNjFk" className="inline-flex items-center px-8 py-4 rounded-full text-lg bg-blue-500 text-white font-semibold hover:bg-blue-600 transition-colors duration-300 neon-button-blue">
              Join Telegram Channel <Image src="/icons/telegram.svg" alt="Telegram" width={40} height={40} className="ml-2" />
            </a>
          </div>
        </section>
